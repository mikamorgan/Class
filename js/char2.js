var char2 = {
    ...
    create: function () {
        ...
        this.bg.scale.setTo(2.75,2.7);
           ...
           // Title
           var logo = game.add.bitmapText(385, 275, 'mainFont', '', 100)
           logo.text = "Superman the Stickman";
           ...
           //}, 1000).start()
           // // Subtitle
           var label = game.add.bitmapText(560, 0, 'mainFont', '', 40);
           label.text = "Use the arrow keys to move";
           game.add.tween(label).to({
               y: 390
           }, 1000, Phaser.Easing.Bounce.Out).start()
   
           var label1 = game.add.bitmapText(595, 0, 'mainFont', '', 40);
           label1.text = "Use a, s, w, d to attack ";
